...
APPROVED_ALIASES: dict[str, list[str]] = {
    ...
    "Messina": ["mesina"],
    "Rosella": ["rosela"],
    "Pan Pizza Beef Special": ["panpizza beef special", "pannpizza beef special", "beef special"],
    "Pan Pizza Rio": ["panpizza rio", "pannpizza rio"],
    "Pan Pizza Catania": [
        "panpizza catania",
        "pannpizza catania",
        "pan pizza katania",
    ...
    "Pan Pizza Palermo": ["panpizza palermo", "pannpizza palermo"],
    "Pan Pizza Florens": ["panpizza florens", "pannpizza florens"],
    ...
    "Spaghetti Carbonara": ["spagetti carbonara", "spagetti karbonara", "spaghetti karbonara", "karbonara"],
